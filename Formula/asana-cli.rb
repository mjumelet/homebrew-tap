class AsanaCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/mjumelet/asana-cli/releases/download/v1.2.1/asana-cli_1.2.1_darwin_arm64.tar.gz"
      sha256 "580beed2da0e1137b317af93245c2eadfbcac8078ec1e38563734ada519ad9ae"
    else
